...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		var size = format(file.size, storageHex, storageUnits, 2);
		var progressSize = document.createElement("div");
		progressSize.className = "progressFileSize";
		progressSize.appendChild(document.createTextNode(size.base + " " + size.unit));
...
FileProgress.prototype.setProgress = function (percentage) {
	...
	var size = format(this.file.sizeUploaded, storageHex, storageUnits, 2);
	var speed = format(this.file.currentSpeed/8, storageHex, storageUnits, 2);
	this.fileProgressElement.childNodes[2].className = "progressBarStatus";
